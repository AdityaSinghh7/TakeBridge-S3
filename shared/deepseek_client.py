...
try:
    ...
    class _MissingOpenAI:  # pragma: no cover
        def __init__(self, *args, **kwargs):
            raise RuntimeError(
                "The 'openai' package is required to instantiate DeepSeekClient. "
                "Install openai>=1.0 to enable DeepSeek calls."
            )
...
class DeepSeekClient:
    """Reusable DeepSeek client for issuing Chat Completions API calls with sane defaults."""
    ...
    def create_response(
        ...
        **kwargs: Any,
        ...
        """
        Issue a Chat Completions API request to DeepSeek.
        """
        ...
        if has_image:
            raise ValueError("DeepSeek does not support image content in chat completions.")
